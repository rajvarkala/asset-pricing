...
ml_pdf = work_dir / 'ML.pdf'
supp_pdf = work_dir / 'hhaa009_supplementary_data.pdf'
out_csv = work_dir / 'top_predictors_page33_dedup_enriched.csv'
out_xlsx = work_dir / 'top_predictors_page33_dedup_enriched.xlsx'
